...
fs.readFile(namesPath, 'utf-8', function (err, fileContents) {
	...
	fs.readFile(d15Path, 'utf-8', function (err, fileContents) {
	  	if (err) throw err;
	  	d1915 = JSON.parse(fileContents);
	  	console.log("loaded " + d1915.length + " records");
		...
		//console.log("filtered to " + d1915.length + " naturalisation records");
...
*/
		...
		var outputFilename = 'd1915Matchnames.json';
