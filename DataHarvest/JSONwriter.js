...
function loadData( page, pagelen, query ){
	...
	// D3597
	//var url = "http://api.trove.nla.gov.au/result?key=vl6ahuf5l47j4vaq&zone=picture&q="+query+"&encoding=json&n="+pagelen+"&s="+(page*pagelen)+"&reclevel=full&include=workversions"

	// Internment + german + holsworthy + liverpool
	var url = "http://api.trove.nla.gov.au/result?key=vl6ahuf5l47j4vaq&zone=picture&q="+query+"&encoding=json&n="+pagelen+"&s="+(page*pagelen)+"&reclevel=full&include=workversions&l-decade=191&l-availability=y/f&l-australian=y"
